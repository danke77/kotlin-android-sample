package com.danke.contacts.medium.component.swipe;
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.danke.contacts.medium.component.swipe.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.danke.contacts.medium.component.swipe.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.danke.contacts.medium.component.swipe.ViewDragHelper.Callback#tryCaptureView(View, int)}
     ...
     * {@link com.danke.contacts.medium.component.swipe.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
